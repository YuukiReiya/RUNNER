...
public class ResultMenu : MonoBehaviour {
    ...
    [Header("Parameter")]
    [SerializeField, Tooltip("リトライUIアニメーター")]
    private Animator continueImageAnimator;
    [SerializeField, Tooltip("タイトルUIアニメーター")]
    private Animator toTitleImageAnimator;
    [SerializeField, Tooltip("リザルトのアニメーター")]
    private Animator resultAnimator;
    [SerializeField, Tooltip("リザルトで非表示にするタイムのゲームオブジェクト")]
    private GameObject timeObject;
    [SerializeField, Tooltip("リザルトで表示するタイムのUIを格納したゲームオブジェクト")]
    private TimeAttackResult timeAttackResult;
    [SerializeField, Tooltip("リザルトで表示するランキングのUIを格納したゲームオブジェクト")]
    private TimeRanking timeRanking;
    ...
    public void Initialize()
    {
        ...
        timeAttackResult.Initialize();
        resultAnimator.SetTrigger("Next");
        menu = Menu.Continue;
        isKey = false;
        isDecision = false;
        timeRanking.Initialize();
    }
